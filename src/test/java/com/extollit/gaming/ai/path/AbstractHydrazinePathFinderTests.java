...
public abstract class AbstractHydrazinePathFinderTests {
    ...
    protected void fuzzy(final int x, final int y, final int z) {
        ...
        when(block.bounds()).thenReturn(new ThreeDimensionalDoubleBox(0, 0, 0, 1, 1, 1));
    ...
    protected void latFence(final int x, final int y, final int z) {
        fence(new ThreeDimensionalDoubleBox(0, 0, 0.45f, 1, 1.5f, 0.55f), x, y, z);
    }

    protected void longFence(final int x, final int y, final int z) {
        fence(new ThreeDimensionalDoubleBox(0.45f, 0, 0, 0.55f, 1.5, 1), x, y, z);
    }

    protected void cornerFenceSouthEast(final int x, final int y, final int z) {
        fence(new ThreeDimensionalDoubleBox(0.45f, 0, 0.45f, 1, 1.5f, 1), x, y, z);
    }

    protected void cornerFenceSouthWest(final int x, final int y, final int z) {
        fence(new ThreeDimensionalDoubleBox(0, 0, 0.45f, 0.55f, 1.5f, 1), x, y, z);
    }

    protected void cornerFenceNorthEast(final int x, final int y, final int z) {
        fence(new ThreeDimensionalDoubleBox(0.45f, 0, 0, 1, 1.5f, 0.55f), x, y, z);
    }

    protected void cornerFenceNorthWest(final int x, final int y, final int z) {
        fence(new ThreeDimensionalDoubleBox(0, 0, 0, 0.55f, 1.5f, 0.55f), x, y, z);
    }

    protected void fence(ThreeDimensionalDoubleBox bounds, final int x, final int y, final int z) {
        IBlockObject
