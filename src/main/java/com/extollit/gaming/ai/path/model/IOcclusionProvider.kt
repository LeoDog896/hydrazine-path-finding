...
interface IOcclusionProvider {
     ...
     *
     * The low two bits of the nibble are used to identify the [Element] of the block and the high two bits of the
     * nibble are used to identify the [Logic] of the block.  There are utility methods on those types for
     ...
     * @return a nibble containing the [Element] and [Logic] information about a block in the instance at
     * the aforementioned coordinates.
     * @see Element
     *
     * @see Logic
     */
    fun elementAt(x: Int, y: Int, z: Int): Byte
